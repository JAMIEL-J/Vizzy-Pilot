...
// Inject styles into document (if running in browser environment)
...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, ...props }, ref) => (
  <textarea
    className={cn(
      "flex w-full rounded-md border-none bg-transparent px-3 py-2.5 text-base text-foreground placeholder:text-muted-foreground/60 focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 min-h-[44px] resize-none scrollbar-thin scrollbar-thumb-[#444444] scrollbar-track-transparent hover:scrollbar-thumb-[#555555]",
      className
    )}
    ref={ref}
    rows={1}
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 z-10 rounded-full bg-surface-2 p-2 hover:bg-surface-3 transition-all">
...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  const { onSend = () => {}, isLoading = false, placeholder = "Type your message here...", className, disabled = false } = props;
  ...
  return (
    <>
      <PromptInput
        ...
        className={cn(
          "w-full bg-surface border-border shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all duration-300 ease-in-out",
          ...
          >
            <PromptInputAction tooltip="Upload image">
              <button
                ...
                className="flex h-8 w-8 text-muted-foreground cursor-pointer items-center justify-center rounded-full transition-colors hover:bg-surface-2 hover:text-foreground"
            ...
            <div className="flex items-center">
              <button
                ...
                className={cn(
                  ...
                  showSearch
                    ? "border border-[#1EAEDB] bg-[#1EAEDB]/15 text-[#1EAEDB]"
              ...
              <button
                ...
                className={cn(
                  "rounded-full transition-all flex items-center gap-1 px-2 py-1 h-8",
                  showThink
                    ? "border border-[#8B5CF6] bg-[#8B5CF6]/15 text-[#8B5CF6]"
                    : "border border-transparent bg-transparent text-[#9CA3AF] hover:text-[#D1D5DB]"
                )}
              >
                <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
          ...
          >
            <Button
              ...
              className={cn(
                ...
                isRecording
                  ? "bg-transparent hover:bg-surface-2 text-red-500 hover:text-red-400"
                  : hasContent
